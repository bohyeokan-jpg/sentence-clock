...
/// Editor for one of the up-to-3 alarm slots (see AlarmSettingsScreen, the
/// list this is pushed from) — [index] picks which slot is being edited.
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('알람 ${widget.index + 1}', style: GoogleFonts.notoSerifKr(color: palette.ink, fontSize: 18)),
      ),
      body: alarmsAsync.when(
        ...
        data: (alarms) {
          final config = alarms[widget.index];
          _initFrom(config);
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Switch(
                      ...
                      onChanged: (v) => ref.read(alarmProvider.notifier).setEnabled(widget.index, v),
                    ),
                  ],
                ),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      await _player.stop();
                      await ref.read(alarmProvider.notifier).saveAt(
                            widget.index,
